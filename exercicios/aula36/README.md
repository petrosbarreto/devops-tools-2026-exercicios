# Exercício Aula 36: Apresentações Finais + Revisão

## 🎯 Objetivo

Portfólio: Publicar todos os projetos no GitHub
...
Aplique os conceitos de **Apresentações Finais + Revisão** em um cenário prático do dia a dia de um profissional DevOps.
...
2. **Clone** seu fork
3. Crie pasta `solucoes/seu-nome/aula36/`
4. Adicione seus arquivos:
   - `README.md` (documentação)
   - Código/configurações
   - Screenshots (se aplicável)
5. **Commit** e **Push**
6. Abra **Pull Request**: `[Aula 36] Seu Nome`
...
- [Slides da Aula 36](../../aulas/aula36/slides.md)
