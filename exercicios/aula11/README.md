# Exercício Aula 11: Dockerfile - Criando Imagens
...
Aplique os conceitos de **Dockerfile - Criando Imagens** em um cenário prático do dia a dia de um profissional DevOps.
...
2. **Clone** seu fork
3. Crie pasta `solucoes/seu-nome/aula11/`
4. Adicione seus arquivos:
   - `README.md` (documentação)
   - Código/configurações
   - Screenshots (se aplicável)
5. **Commit** e **Push**
6. Abra **Pull Request**: `[Aula 11] Seu Nome`
...
- [Slides da Aula 11](../../aulas/aula11/slides.md)
