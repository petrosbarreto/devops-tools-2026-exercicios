...
Colocar em prática os conceitos de **Dockerfile: Criando Imagens**.
...
3. Crie/edite os arquivos na pasta `exercicios/aula11/`
4. Teste localmente
5. Commit e push
6. Abra um Pull Request: `[Aula 11] Seu Nome`

## 📦 Entrega

- **Pasta:** `exercicios/aula11/`
