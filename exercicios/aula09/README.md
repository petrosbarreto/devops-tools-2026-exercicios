# Exercício Aula 09: Introdução a Containers

## 🎯 Objetivo

Relatório: Quando usar VM vs Container
...
Aplique os conceitos de **Introdução a Containers** em um cenário prático do dia a dia de um profissional DevOps.
...
2. **Clone** seu fork
3. Crie pasta `solucoes/seu-nome/aula09/`
4. Adicione seus arquivos:
   - `README.md` (documentação)
   - Código/configurações
   - Screenshots (se aplicável)
5. **Commit** e **Push**
6. Abra **Pull Request**: `[Aula 09] Seu Nome`
...
- [Slides da Aula 09](../../aulas/aula09/slides.md)
