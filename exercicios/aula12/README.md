# Exercício Aula 12: Docker - Redes e Volumes

## 🎯 Objetivo

Sistema com 3 containers conectados + volume persistente
...
Aplique os conceitos de **Docker - Redes e Volumes** em um cenário prático do dia a dia de um profissional DevOps.
...
2. **Clone** seu fork
3. Crie pasta `solucoes/seu-nome/aula12/`
4. Adicione seus arquivos:
   - `README.md` (documentação)
   - Código/configurações
   - Screenshots (se aplicável)
5. **Commit** e **Push**
6. Abra **Pull Request**: `[Aula 12] Seu Nome`
...
- [Slides da Aula 12](../../aulas/aula12/slides.md)
