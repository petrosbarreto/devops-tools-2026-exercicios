# Exercício Aula 14: Boas Práticas com Docker

## 🎯 Objetivo

Auditoria de segurança em Dockerfile
...
Aplique os conceitos de **Boas Práticas com Docker** em um cenário prático do dia a dia de um profissional DevOps.
...
2. **Clone** seu fork
3. Crie pasta `solucoes/seu-nome/aula14/`
4. Adicione seus arquivos:
   - `README.md` (documentação)
   - Código/configurações
   - Screenshots (se aplicável)
5. **Commit** e **Push**
6. Abra **Pull Request**: `[Aula 14] Seu Nome`
...
- [Slides da Aula 14](../../aulas/aula14/slides.md)
