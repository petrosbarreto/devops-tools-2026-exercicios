...
Colocar em prática os conceitos de **Container Registries**.
...
3. Crie/edite os arquivos na pasta `exercicios/aula15/`
4. Teste localmente
5. Commit e push
6. Abra um Pull Request: `[Aula 15] Seu Nome`

## 📦 Entrega

- **Pasta:** `exercicios/aula15/`
