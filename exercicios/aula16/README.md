# Exercício Aula 16: Docker: Segurança

## 🎯 Objetivo

Colocar em prática os conceitos de **Docker: Segurança**.
...
3. Crie/edite os arquivos na pasta `exercicios/aula16/`
4. Teste localmente
5. Commit e push
6. Abra um Pull Request: `[Aula 16] Seu Nome`

## 📦 Entrega

- **Pasta:** `exercicios/aula16/`
