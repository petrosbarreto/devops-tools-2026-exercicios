# Exercício Aula 26: Helm - Package Manager para K8s

## 🎯 Objetivo

Customizar chart via values.yaml
...
Aplique os conceitos de **Helm - Package Manager para K8s** em um cenário prático do dia a dia de um profissional DevOps.
...
2. **Clone** seu fork
3. Crie pasta `solucoes/seu-nome/aula26/`
4. Adicione seus arquivos:
   - `README.md` (documentação)
   - Código/configurações
   - Screenshots (se aplicável)
5. **Commit** e **Push**
6. Abra **Pull Request**: `[Aula 26] Seu Nome`
...
- [Slides da Aula 26](../../aulas/aula26/slides.md)
