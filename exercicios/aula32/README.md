# Exercício Aula 32: Beats - Coletores Leves

## 🎯 Objetivo

Coletar métricas de app containerizado
...
Aplique os conceitos de **Beats - Coletores Leves** em um cenário prático do dia a dia de um profissional DevOps.
...
2. **Clone** seu fork
3. Crie pasta `solucoes/seu-nome/aula32/`
4. Adicione seus arquivos:
   - `README.md` (documentação)
   - Código/configurações
   - Screenshots (se aplicável)
5. **Commit** e **Push**
6. Abra **Pull Request**: `[Aula 32] Seu Nome`
...
- [Slides da Aula 32](../../aulas/aula32/slides.md)
