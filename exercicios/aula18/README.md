# Exercício Aula 18: Apresentação de Projetos Docker

## 🎯 Objetivo

Preparar ambiente Kubernetes (instalar kubectl, minikube)
...
Aplique os conceitos de **Apresentação de Projetos Docker** em um cenário prático do dia a dia de um profissional DevOps.
...
2. **Clone** seu fork
3. Crie pasta `solucoes/seu-nome/aula18/`
4. Adicione seus arquivos:
   - `README.md` (documentação)
   - Código/configurações
   - Screenshots (se aplicável)
5. **Commit** e **Push**
6. Abra **Pull Request**: `[Aula 18] Seu Nome`
...
- [Slides da Aula 18](../../aulas/aula18/slides.md)
