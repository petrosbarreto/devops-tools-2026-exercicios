# Exercício Aula 18: Projeto: Aplicação Full Stack

## 🎯 Objetivo

Colocar em prática os conceitos de **Projeto: Aplicação Full Stack**.
...
3. Crie/edite os arquivos na pasta `exercicios/aula18/`
4. Teste localmente
5. Commit e push
6. Abra um Pull Request: `[Aula 18] Seu Nome`

## 📦 Entrega

- **Pasta:** `exercicios/aula18/`
