# Exercício Aula 17: Docker: Otimização

## 🎯 Objetivo

Colocar em prática os conceitos de **Docker: Otimização**.
...
3. Crie/edite os arquivos na pasta `exercicios/aula17/`
4. Teste localmente
5. Commit e push
6. Abra um Pull Request: `[Aula 17] Seu Nome`

## 📦 Entrega

- **Pasta:** `exercicios/aula17/`
