# Exercício Aula 17: Projeto Prático: Aplicação Containerizada

## 🎯 Objetivo

Completar aplicação + documentação
...
Aplique os conceitos de **Projeto Prático: Aplicação Containerizada** em um cenário prático do dia a dia de um profissional DevOps.
...
2. **Clone** seu fork
3. Crie pasta `solucoes/seu-nome/aula17/`
4. Adicione seus arquivos:
   - `README.md` (documentação)
   - Código/configurações
   - Screenshots (se aplicável)
5. **Commit** e **Push**
6. Abra **Pull Request**: `[Aula 17] Seu Nome`
...
- [Slides da Aula 17](../../aulas/aula17/slides.md)
