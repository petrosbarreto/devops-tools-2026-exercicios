# Exercício Aula 28: Projeto: Deploy K8s + Helm

## 🎯 Objetivo

Colocar em prática os conceitos de **Projeto: Deploy K8s + Helm**.
...
3. Crie/edite os arquivos na pasta `exercicios/aula28/`
4. Teste localmente
5. Commit e push
6. Abra um Pull Request: `[Aula 28] Seu Nome`

## 📦 Entrega

- **Pasta:** `exercicios/aula28/`
