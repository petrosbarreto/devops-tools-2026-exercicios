...
Colocar em prática os conceitos de **Elasticsearch: Fundamentos**.
...
3. Crie/edite os arquivos na pasta `exercicios/aula30/`
4. Teste localmente
5. Commit e push
6. Abra um Pull Request: `[Aula 30] Seu Nome`

## 📦 Entrega

- **Pasta:** `exercicios/aula30/`
