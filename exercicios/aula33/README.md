# Exercício Aula 33: Kibana: Visualização

## 🎯 Objetivo

Colocar em prática os conceitos de **Kibana: Visualização**.
...
3. Crie/edite os arquivos na pasta `exercicios/aula33/`
4. Teste localmente
5. Commit e push
6. Abra um Pull Request: `[Aula 33] Seu Nome`

## 📦 Entrega

- **Pasta:** `exercicios/aula33/`
