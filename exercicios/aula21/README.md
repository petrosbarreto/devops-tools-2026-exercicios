# Exercício Aula 21: Services e Networking

## 🎯 Objetivo

App multi-tier com services interconectados
...
Aplique os conceitos de **Services e Networking** em um cenário prático do dia a dia de um profissional DevOps.
...
2. **Clone** seu fork
3. Crie pasta `solucoes/seu-nome/aula21/`
4. Adicione seus arquivos:
   - `README.md` (documentação)
   - Código/configurações
   - Screenshots (se aplicável)
5. **Commit** e **Push**
6. Abra **Pull Request**: `[Aula 21] Seu Nome`
...
- [Slides da Aula 21](../../aulas/aula21/slides.md)
