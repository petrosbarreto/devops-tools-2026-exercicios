...
Colocar em prática os conceitos de **Introdução ao Kubernetes**.
...
3. Crie/edite os arquivos na pasta `exercicios/aula19/`
4. Teste localmente
5. Commit e push
6. Abra um Pull Request: `[Aula 19] Seu Nome`

## 📦 Entrega

- **Pasta:** `exercicios/aula19/`
