# Exercício Aula 19: Introdução ao Kubernetes

## 🎯 Objetivo

Diagrama da arquitetura K8s anotado
...
Aplique os conceitos de **Introdução ao Kubernetes** em um cenário prático do dia a dia de um profissional DevOps.
...
2. **Clone** seu fork
3. Crie pasta `solucoes/seu-nome/aula19/`
4. Adicione seus arquivos:
   - `README.md` (documentação)
   - Código/configurações
   - Screenshots (se aplicável)
5. **Commit** e **Push**
6. Abra **Pull Request**: `[Aula 19] Seu Nome`
...
- [Slides da Aula 19](../../aulas/aula19/slides.md)
