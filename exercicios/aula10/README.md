# Exercício Aula 10: Introdução ao Docker

## 🎯 Objetivo

Colocar em prática os conceitos de **Introdução ao Docker**.
...
3. Crie/edite os arquivos na pasta `exercicios/aula10/`
4. Teste localmente
5. Commit e push
6. Abra um Pull Request: `[Aula 10] Seu Nome`

## 📦 Entrega

- **Pasta:** `exercicios/aula10/`
