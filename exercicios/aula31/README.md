# Exercício Aula 31: Logstash - Ingestão de Dados

## 🎯 Objetivo

Pipeline complexo com múltiplos filtros
...
Aplique os conceitos de **Logstash - Ingestão de Dados** em um cenário prático do dia a dia de um profissional DevOps.
...
2. **Clone** seu fork
3. Crie pasta `solucoes/seu-nome/aula31/`
4. Adicione seus arquivos:
   - `README.md` (documentação)
   - Código/configurações
   - Screenshots (se aplicável)
5. **Commit** e **Push**
6. Abra **Pull Request**: `[Aula 31] Seu Nome`
...
- [Slides da Aula 31](../../aulas/aula31/slides.md)
