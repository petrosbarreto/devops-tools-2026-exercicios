...
Colocar em prática os conceitos de **Introdução ao DevOps**.
...
3. Crie/edite os arquivos na pasta `exercicios/aula01/`
4. Teste localmente
5. Commit e push
6. Abra um Pull Request: `[Aula 01] Seu Nome`

## 📦 Entrega

- **Pasta:** `exercicios/aula01/`
