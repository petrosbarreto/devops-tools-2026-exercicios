# Exercício Aula 25: Namespaces e RBAC

## 🎯 Objetivo

Implementar RBAC para diferentes equipes
...
Aplique os conceitos de **Namespaces e RBAC** em um cenário prático do dia a dia de um profissional DevOps.
...
2. **Clone** seu fork
3. Crie pasta `solucoes/seu-nome/aula25/`
4. Adicione seus arquivos:
   - `README.md` (documentação)
   - Código/configurações
   - Screenshots (se aplicável)
5. **Commit** e **Push**
6. Abra **Pull Request**: `[Aula 25] Seu Nome`
...
- [Slides da Aula 25](../../aulas/aula25/slides.md)
